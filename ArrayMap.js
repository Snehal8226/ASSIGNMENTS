...
//Array Map  (Map always in key n value pair key can be any datatype)

//1.set()method

    /*const vehicals = new Map();

  // Set Map Values
     vehicals.set("Jupiter", 700000);
     vehicals.set("Java42", 2500000);

     document.write(vehicals.get("Java42"));
     ...
     document.write(vehicals.get("Jupiter"));
     ...
     vehicals.delete("Jupiter");
     document.write(vehicals.size);

     //3. has() method it returns true if value present in map
     const vehicals = new Map();
     vehicals.set("Jupiter", 700000);
     vehicals.set("Java42", 2500000);
     ...
     //function processArray(...str) {
        document.write("Array practice print num 1 to 10", str);
